					...
					if i == 1 :
						while true :
							...
							and sahte_cevap != d_daki_cevap):
								...
								A_cevap.text = "A) %s" % Turkce[sahte_cevap-1].capitalize()
								break
						...
						while true :
							...
							and sahte_cevap != d_daki_cevap):
								...
								B_cevap.text = "B) %s" % Turkce[sahte_cevap-1].capitalize()
								break
						...
						while true :
							...
							and sahte_cevap != d_daki_cevap):
								...
								C_cevap.text = "C) %s" % Turkce[sahte_cevap-1].capitalize()
								break
						...
						while true :
							...
							and sahte_cevap != d_daki_cevap):
								...
								D_cevap.text = "D) %s" % Turkce[sahte_cevap-1].capitalize()
								break

				else :
					if i == 1 :
						A_cevap.text = "A) %s" % Turkce[random_kelime-1].capitalize()
						a_daki_cevap = random_kelime
					elif i == 2 :
						B_cevap.text = "B) %s" % Turkce[random_kelime-1].capitalize()
						b_daki_cevap = random_kelime
					elif i == 3 :
						C_cevap.text = "C) %s" % Turkce[random_kelime-1].capitalize()
						c_daki_cevap = random_kelime
					elif i == 4 :
						D_cevap.text = "D) %s" % Turkce[random_kelime-1].capitalize()
						d_daki_cevap = random_kelime
			bayrak = 0

		if bayrak == 0 :
			$SorulanKelime.text = "' %s '" % Osmanlica[random_kelime-1].capitalize()
